...
<main>
    <div class="form-box">
        ...
        <button onclick="window.location.href='edit_profile1.php?id1=<?php echo $user['id1']; ?>'">Edit Profile</button>
    </div>
</main>
<footer>
...
<script>
    function goBack() {
        // Redirect to mainS.php with the id1 parameter
        var id1 = <?php echo $user['id1']; ?>;
