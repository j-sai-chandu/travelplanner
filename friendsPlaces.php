...
$sql = "SELECT friends_places, friends_best_time, friends_min_cost FROM destinations1 WHERE id = ?";
...
<head>
    ...
    <title>Friends Travel Planner</title>
    <style>
         body {
...
<div class="note">
    Note: This is the minimum travel cost for 1 person. It may vary based on the group size, your travel type, location, and time. This is an assumption and may vary.
</div>
