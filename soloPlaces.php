...
$sql = "SELECT solo_places, solo_best_time, solo_min_cost FROM destinations1 WHERE id = ?";
...
<head>
    ...
    <title>Solo Travel Planner</title>
    <style>
         body {
...
<div class="note">
    Note: This is the minimum travel cost for solo travelers. Costs may vary based on your location, time, and travel preferences. This is an assumption and may vary.
</div>
...
function checkLoginAndRedirect() {
    ...
    const id = "<?php echo $id; ?>"; // Fetch the PHP value for id

    if (id1 === 'null') {
        alert("Please login or create an account to provide feedback.");
        window.location.href = `login2.html`; // Updated to include both id and id1
    } else {
